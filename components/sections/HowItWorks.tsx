    ...
    <section id="how-it-works" className="py-20 md:py-28 bg-[#FAF9F7] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block relative py-8">
          ...
          <div className="absolute top-1/2 left-12 right-12 h-1 bg-[#EDE9FE] -translate-y-6 z-0" />
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* UI Snippet Tag */}
                  <div className="pt-2">
                    <span className="text-[11px] font-mono font-semibold px-2.5 py-1 rounded-md bg-[#EDE9FE] text-[#7C3AED] border border-[#7C3AED]/20 shadow-xs">
                      {step.snippet}
                    </span>
                  </div>
                </motion.div>
        ...
        <div className="lg:hidden relative pl-6 space-y-8 py-4">
          {/* Vertical Line */}
          <div className="absolute top-4 bottom-4 left-[27px] w-1 bg-[#EDE9FE]" />
              ...
              >
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-200/90 shadow-xs flex-1 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#EDE9FE] text-[#7C3AED] font-semibold">
                      {step.snippet}
                    </span>
                  </div>
                  <h3 className="font-bold text-base text-[#242124] font-manrope">
